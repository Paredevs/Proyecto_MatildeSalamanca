...
<html lang="en" dir="ltr">
  ...
  {/*aqui iban los botones antes: ingresar notas etc */}
    ...
    <img src="    https://s3.amazonaws.com/gobcl-prod/filer_public_thumbnails/public_files/2022/subsecretarios/camilavallejo.jpg__328x342_q85_crop_subsampling-2.jpg
" alt="usuario"></img>
   ...
   <footer>
    ...
    <section>
    {/*<div class="botones">*/}
        <button class="btn btn-primary">Inscribir Apoderado/Alumno</button>
        <button class="btn btn-primary">Actualizar Datos Apoderado/Alumno</button>
        <button class="btn btn-primary">Ver Datos Apoderado/Alumno</button>
        <button class="btn btn-primary">Ver situcaion academica Alumno</button>
  { /* </div> */}
    </section>
  </body>
</html>
