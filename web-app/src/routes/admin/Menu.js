...
if (alertTrigger) {
  alertTrigger.addEventListener('click', () => {
    ...
    return(
      ...
      <section>
        {/*<div class="botones">*/}
        <a href={routes.register} className="btn btn-primary">Nuevo usuario</a>
        ...
        <a href={routes.profesor.anotacion_nueva} className="btn btn-primary">Lista de Apoderados</a>
        <button type="button" className="btn btn-primary"  id="liveAlertBtn">alerta</button>
        {/* </div> */}
      </section>
