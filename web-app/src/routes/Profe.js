...
function Profe() {
  ...
  <div className="Profesor">
        ...
        <div className="sidebar">
          ...
          <ul>
            <li>
            <b> Nombre de Usuario {localStorage.getItem("name")}</b>
            </li>
            <li>
              <a href="/#">
        ...
        <footer>
          ...
          <div className="text-center"><p className="text-footer">   <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-telephone" viewBox="0 0 16 16">
        ...
        <section>
          {/*<div class="botones">*/}
          <a href={routes.profesor.nota_nueva} className="btn btn-primary">Ingresar Notas</a>
          <a href={routes.profesor.ingresar_asistencia} className="btn btn-primary">Ingresar Asistencia</a>
          {/* <button class="btn btn-primary">Ingresar Anotaciones</button> */}
          <a href={routes.profesor.anotacion_nueva} className="btn btn-primary">Ingresar Anotaciones</a>
